...
// ==================== サイン・戦術（追加30問） ====================
const additionalTactics2: Question[] = [
  {
    id: 'q71',
    type: '4択',
    category: 'サイン・戦術',
    ...
    correctIndex: 2,
    explanation:
      'ピックオフプレー（サインプレー）は投手と内野手が<ruby>事前<rt>じぜん</rt></ruby>に決めたサインとタイミングで動き、ランナーを<ruby>牽制<rt>けんせい</rt></ruby>アウトにする作戦。特に2<ruby>塁<rt>るい</rt></ruby>への<ruby>牽制<rt>けんせい</rt></ruby>で遊撃手や二塁手と<ruby>連携<rt>れんけい</rt></ruby>して行うことが多い。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [2] },
  },
  {
    ...
    correctIndex: 1,
    explanation:
      '満<ruby>塁<rt>るい</rt></ruby>では故意四球を選択すると押し出しで相手に1点が入るため、通常は行わない。故意四球は2<ruby>塁<rt>るい</rt></ruby>や1・2<ruby>塁<rt>るい</rt></ruby>など、1<ruby>塁<rt>るい</rt></ruby>が空いている場面で強打者を避けるときに使う戦術。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q73',
    ...
    correctIndex: 1,
    explanation:
      'ランナーが2<ruby>塁<rt>るい</rt></ruby>にいると投手板の後ろからサインが見えやすくなる。そのため<ruby>捕手<rt>ほしゅ</rt></ruby>は複数のサインを組み合わせた「複合サイン」に切り替えて、サインを読まれにくくする工夫をする。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [2] },
  },
  {
    ...
    correctIndex: 1,
    explanation:
      '走者が1<ruby>塁<rt>るい</rt></ruby>からシングルヒットで3<ruby>塁<rt>るい</rt></ruby>まで進むには、打球が外野のどこに飛んだか・走者の打球への反応・ベースコーチの指示など複合的な<ruby>判断<rt>はんだん</rt></ruby>が必要。特に打球がどの方向に転がるかによって進<ruby>塁<rt>るい</rt></ruby>できるかが大きく変わる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q75',
    ...
    correctIndex: 1,
    explanation:
      '申告敬遠とは、投手が1球も投げずに監督が審判に意図的四球を申告し、打者を1<ruby>塁<rt>るい</rt></ruby>へ進める制度。意図的にボール球を投げ続けるのは「故意四球（敬遠）」で、申告敬遠は投球なしで即座に四球が成立する点が違う。',
    source: '公認野球<ruby>規則<rt>きそく</rt></ruby>',
  },
  {
    id: 'q76',
    ...
    correctIndex: 1,
    explanation:
      'ディレイドスチールは通常の盗<ruby>塁<rt>るい</rt></ruby>（投球時スタート）と違い、<ruby>捕手<rt>ほしゅ</rt></ruby>が投手に返球した瞬間などすきを突いて走る遅<ruby>延<rt>えん</rt></ruby>型盗<ruby>塁<rt>るい</rt></ruby>。守備陣が油断した隙に仕掛けるため、意外性が武器。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q77',
    ...
    correctIndex: 1,
    explanation:
      'シフト守備は打者ごとの打球方向の傾向（引っ張り方向が多い打者など）に合わせて守備位置を変える戦術。近年のMLBで普及し、左打者の引っ張りに合わせた「オーバーシフト」が有名。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q78',
    ...
    correctIndex: 0,
    explanation:
      'ファウルチップ（バットに当たり<ruby>捕手<rt>ほしゅ</rt></ruby>がノーバウンドで捕球）はストライクとして扱われ、打者はアウトにもならないが走者に対しては通常の投球扱いとなる。ただし2ストライク時にファウルチップで<ruby>捕手<rt>ほしゅ</rt></ruby>が捕球すれば三振アウトになる。',
    source: '公認野球<ruby>規則<rt>きそく</rt></ruby>',
  },
  {
    id: 'q79',
    ...
    correctIndex: 0,
    explanation:
      'バスターはバントの構えで守備側を前に引き出してから、バントをやめてスイングに切り替えて打つプレー。守備側がバントシフトを取ってくる場面に対して有効な攻撃戦術。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q80',
    ...
    correctIndex: 2,
    explanation:
      'ノーアウト3<ruby>塁<rt>るい</rt></ruby>でダブルスチールを狙うには1<ruby>塁<rt>るい</rt></ruby>にもランナーが必要。この場面では1<ruby>塁<rt>るい</rt></ruby>のランナーがいないためダブルスチールは成立しない。スクイズ・犠牲フライ・暴投のホーム突入などが守備側の注意点。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [3] },
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'ベースコーチ（塁<ruby>審補佐<rt>しんぽさ</rt></ruby>）は試合中にボールや選手に触れることが<ruby>禁止<rt>きんし</rt></ruby>されている。もしコーチが走者の身体を押したり引いたりしてプレーに介入した場合、その走者はアウトになる。',
    source: '公認野球<ruby>規則<rt>きそく</rt></ruby>',
  },
  {
    id: 'q82',
    ...
    correctIndex: 0,
    explanation:
      'フォースバント（犠牲バント）の代表的場面は無死1<ruby>塁<rt>るい</rt></ruby>。バントでランナーを2<ruby>塁<rt>るい</rt></ruby>に進め、1点を取りやすくする。無死1・2<ruby>塁<rt>るい</rt></ruby>で2<ruby>塁<rt>るい</rt></ruby>・3<ruby>塁<rt>るい</rt></ruby>に進める場面でも使われる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [1], arrows: [{ from: 1, to: 2 }] },
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'タッチアップは外野フライを外野手が<ruby>捕球<rt>ほきゅう</rt></ruby>した後に走者が<ruby>塁<rt>るい</rt></ruby>を離れ進<ruby>塁<rt>るい</rt></ruby>するプレー。3<ruby>塁<rt>るい</rt></ruby>からのホームインが有名だが、2<ruby>塁<rt>るい</rt></ruby>から3<ruby>塁<rt>るい</rt></ruby>や3<ruby>塁<rt>るい</rt></ruby>からホームへのタッチアップも状況次第で可能。外野フライが深く・遠い場合ほど走者が進<ruby>塁<rt>るい</rt></ruby>できる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [2], arrows: [{ from: 2, to: 3 }] },
  },
  {
    id: 'q84',
    type: '4択',
    ...
    correctIndex: 1,
    explanation:
      'ワインドアップで足を大きく高く上げる投手はモーションが大きい分、投球動作の時間が長くなる。そのため走者がスタートを切りやすく盗<ruby>塁<rt>るい</rt></ruby>されやすい。盗<ruby>塁<rt>るい</rt></ruby>の多い走者を出した後はセットポジションに切り替える投手が多い。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [1] },
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'ヒットエンドランはバッターが必ず打つ（空振りでもスイングが<ruby>義務<rt>ぎむ</rt></ruby>）のに対し、エンドランはランナーがスタートを切るが打者は打てる球だけを打ち、打てなければ見逃してもよいとされる。ただしチームや指導者によって定義が異なることもある。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q86',
    ...
    correctIndex: 1,
    explanation:
      '<ruby>捕手<rt>ほしゅ</rt></ruby>は投手へのサイン（球種・コース）だけでなく、守備位置の指示（外野・内野のシフト）や、<ruby>牽制<rt>けんせい</rt></ruby>のサイン、バント守備のサインなども出す。チームの司令塔として守備全体をコントロールする役割がある。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q87',
    ...
    correctIndex: 0,
    explanation:
      '3<ruby>塁<rt>るい</rt></ruby>コーチャーは走者が2<ruby>塁<rt>るい</rt></ruby>ベースを回る際、外野からの送球状況を見て「止まれ（3<ruby>塁<rt>るい</rt></ruby>でストップ）」か「行け（ホームへ）」を<ruby>判断<rt>はんだん</rt></ruby>する。外野手が素早くボールを拾えた場合は本<ruby>塁<rt>るい</rt></ruby>でアウトになるリスクがあるため止まれの指示を出す。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q88',
    ...
    correctIndex: 1,
    explanation:
      'インフィールドフライは攻撃側を守るルール。ノーアウト・1アウトで1・2<ruby>塁<rt>るい</rt></ruby>または満<ruby>塁<rt>るい</rt></ruby>のとき、内野手が普通の努力で捕れる高いフライに審判が宣告。打者は自動的にアウトになり走者のフォースアウトを防ぐ。',
    source: '公認野球<ruby>規則<rt>きそく</rt></ruby>',
    diagram: { runners: [1, 2] },
  },
  {
    ...
    correctIndex: 0,
    explanation:
      '監督はベンチ（ダッグアウト）からサインを出し、3<ruby>塁<rt>るい</rt></ruby>コーチャーや1<ruby>塁<rt>るい</rt></ruby>コーチャーを経由してランナーや打者にサインを伝えるのが一般的。監督が直接サインを出すことも多く、体の動作（帽子・顔・腕など）でサインを送る。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q90',
    ...
    correctIndex: 1,
    explanation:
      '代打は投手の打順（特にDHがないリーグや少年野球）や、走者がいる場面で確実に打てる打者を使い得点を取りたいときに使う。一度交代した選手は再出場できないため、使うタイミングが重要な戦術。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q91',
    ...
    correctIndex: 1,
    explanation:
      '走者が故意に二塁手・遊撃手のゲッツー送球を妨害した場合は守備妨害となり、その走者はアウト。さらに打者走者もアウトになりダブルプレーが成立する。走者は規定のベースラインの中を走り、正当なスライディングで守備を妨害しないようにしなければならない。',
    source: '公認野球<ruby>規則<rt>きそく</rt></ruby>',
  },
  {
    id: 'q92',
    ...
    correctIndex: 0,
    explanation:
      'オーバーシフトなど守備シフトで右側に外野手が集まると、左側（レフト方向）の守備が手薄になるため、流し打ちでレフトへの安打が出やすくなる。これを利用して逆方向に打つのが攻撃側の対策。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q93',
    ...
    correctIndex: 1,
    explanation:
      '野球のサインは相手チームに読まれないよう、監督やコーチが帽子・顔・腕・腰などを触る動作を組み合わせて伝えるのが一般的。「サイン盗み」を防ぐために複雑なサイン体系が使われる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q94',
    ...
    correctIndex: 0,
    explanation:
      '2アウト満<ruby>塁<rt>るい</rt></ruby>では打者が打てば全ランナーが進<ruby>塁<rt>るい</rt></ruby>できる状況。盗<ruby>塁<rt>るい</rt></ruby>を試みてアウトになるとチャンスが消え、成功してもあまりメリットがないため、リスクが高い盗<ruby>塁<rt>るい</rt></ruby>サインは通常出さない。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q95',
    ...
    correctIndex: 1,
    explanation:
      'ウエストボール（外し球）は<ruby>捕手<rt>ほしゅ</rt></ruby>が立ち上がって捕りやすい高い位置にわざとボールを外して投げること。主に盗<ruby>塁<rt>るい</rt></ruby>を警戒する場面や、スクイズを外す場面（スクイズ外し）で使われる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [3] },
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'サインを出した後に取り消すときは「消しサイン」と呼ばれる特定の動作（例：帽子のつばを触る、胸を叩くなど）を使ってサインをキャンセルする。消しサインを確認しないと、キャンセルされたサインで選手が動いてしまうミスが起きる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q97',
    ...
    correctIndex: 0,
    explanation:
      '大差で<ruby>負<rt>ま</rt></ruby>けている場面では、犠牲バントで1点を取るより、ビッグイニング（複数得点）を狙って強攻策を取る方が試合をひっくり返せる可能性が高い。犠牲バントは1点が欲しい僅差の場面で最も効果的な戦術。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
  },
  {
    id: 'q98',
    ...
    correctIndex: 1,
    explanation:
      '前進守備の最大のデメリットは、内野手が前に出る分、後ろの守備範囲が広がり、通常ならアウトにできるゴロがヒットになりやすくなること。「ゲッツーが取れなくなる」という側面もある。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [3] },
  },
  {
    ...
    correctIndex: 1,
    explanation:
      '盗<ruby>塁<rt>るい</rt></ruby>成功のカギは①走者がスタートを切るタイミング（投手の足が動いた瞬間）②走者の走力（足の速さ）③投手の投球動作の読み（クイックの速さ・軸足の動き）④<ruby>捕手<rt>ほしゅ</rt></ruby>の肩の強さ。特にスタートのタイミングが最も重要。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [1], arrows: [{ from: 1, to: 2 }] },
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'バントエンドランはランナーが投球と同時にスタートを切り、打者がバントをすることで、ランナーが通常のバントより1つ余分に進<ruby>塁<rt>るい</rt></ruby>することを狙うプレー。例えば1<ruby>塁<rt>るい</rt></ruby>ランナーが2<ruby>塁<rt>るい</rt></ruby>を回って3<ruby>塁<rt>るい</rt></ruby>まで進める場面などで使われる。',
    source: '野球戦術の<ruby>基本<rt>きほん</rt></ruby>',
    diagram: { runners: [1], arrows: [{ from: 1, to: 3 }] },
  },
];

defaultQuestions.push(...additionalTactics2);
